...
import { RatingsPage } from "@/components/ecommerce/RatingPage";
import { Layout } from "@/components";
import SizeChartDialog from "@/components/SizeChart";
...
import BoutiqueProductImages from "@/components/boutique/BoutiqueProductImages";
import BoutiqueLayout from "@/components/boutique/BoutiqueLayout";


const BoutiqueProductDetails = () => {
  ...
  const { data, request, error, loading } = useApi(boutiqueService.getProductDetails);
  ...
  const shortDescription = product?.product_details?.short_description ?? "";
  const longDescription = product?.product_details?.long_discription ?? "";
console.log(product?.product_details, 'shortDescription')
                      ...
                      return (
                        <button
                          ...
                          onClick={() => {
                            ...
                            navigate(`/boutique/${id}?${params.toString()}`, {
                              replace: true,
                            });
                          }}
                          className={`
...
export default BoutiqueProductDetails;
